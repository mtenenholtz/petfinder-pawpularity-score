...
python train.py --model_name swin_large_patch4_window7_224_in22k --name random_resize_reg_aug --lr 2e-5 --wd 1e-2 --batch_size 8 --accumulate_grad_batches 4
python train.py --model_name swin_large_patch4_window7_224_in22k --name random_resize_reg_aug --lr 2e-5 --wd 1e-2 --batch_size 8 --accumulate_grad_batches 4 --seed 42
python train.py --model_name swin_large_patch4_window7_224_in22k --name random_resize_reg_aug --lr 2e-5 --wd 1e-2 --batch_size 8 --accumulate_grad_batches 4 --seed 26